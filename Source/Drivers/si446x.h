...
#define SI_CSN_LOW( )   GPIO_ResetBits( GPIOB, GPIO_Pin_12 );
#define SI_CSN_HIGH( )  GPIO_SetBits( GPIOB, GPIO_Pin_12 );

#define SI_SDN_LOW( )   GPIO_ResetBits( GPIOA, GPIO_Pin_8 );
#define SI_SDN_HIGH( )  GPIO_SetBits( GPIOA, GPIO_Pin_8 );
