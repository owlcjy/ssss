...
// INPUT DATA
/*
// Crys_freq(Hz): 26000000    Crys_tol(ppm): 20    IF_mode: 2    High_peRF_M300k1_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 0    
...
// # WB filter 3 (BW =  26.75 kHz);  NB-filter 3 (BW = 26.75 kHz)
// 
// Modulation index: 2
*/
...
/*
// Command:                  RF_M300k1_POWER_UP
// Description:              Command to power-up the device and select the operational mode and functionality.
*/
#define RF_M300k1_POWER_UP 0x02, 0x01, 0x00, 0x01, 0x8C, 0xBA, 0x80

/*
// Command:                  RF_M300k1_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
*/
#define RF_M300k1_GPIO_PIN_CFG 0x13, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_M300k1_GLOBAL_XO_TUNE_2
...
*/
#define RF_M300k1_GLOBAL_XO_TUNE_2 0x11, 0x00, 0x02, 0x00, 0x36, 0x00

/*
// Set properties:           RF_M300k1_GLOBAL_CONFIG_1
...
*/
#define RF_M300k1_GLOBAL_CONFIG_1 0x11, 0x00, 0x01, 0x03, 0x60

/*
// Set properties:           RF_M300k1_INT_CTL_ENABLE_2
// Number of properties:     2
// Group ID:                 0x01
// Start ID:                 0x00
...
*/
#define RF_M300k1_INT_CTL_ENABLE_2 0x11, 0x01, 0x02, 0x00, 0x01, 0xD8

/*
// Set properties:           RF_M300k1_FRR_CTL_A_MODE_4
...
*/
#define RF_M300k1_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_M300k1_PREAMBLE_CONFIG_1
// Number of properties:     1
// Group ID:                 0x10
// Start ID:                 0x04
// Default values:           0x21, 
...
*/
#define RF_M300k1_PREAMBLE_CONFIG_1 0x11, 0x10, 0x01, 0x04, 0x31

/*
// Set properties:           RF_M300k1_SYNC_CONFIG_3
...
*/
#define RF_M300k1_SYNC_CONFIG_3 0x11, 0x11, 0x03, 0x00, 0x01, 0xB4, 0x2B

/*
// Set properties:           RF_M300k1_PKT_CONFIG1_1
// Number of properties:     1
// Group ID:                 0x12
// Start ID:                 0x06
// Default values:           0x00, 
...
*/
#define RF_M300k1_PKT_CONFIG1_1 0x11, 0x12, 0x01, 0x06, 0x02

/*
// Set properties:           RF_M300k1_PKT_FIELD_1_CONFIG_1
// Number of properties:     1
// Group ID:                 0x12
// Start ID:                 0x0F
// Default values:           0x00, 
...
*/
#define RF_M300k1_PKT_FIELD_1_CONFIG_1 0x11, 0x12, 0x01, 0x0F, 0x04

/*
// Set properties:           RF_M300k1_MODEM_MOD_TYPE_12
...
*/
#define RF_M300k1_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x02, 0x00, 0x07, 0x00, 0x27, 0x10, 0x01, 0x8C, 0xBA, 0x80, 0x00, 0x00

/*
// Set properties:           RF_M300k1_MODEM_FREQ_DEV_0_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x0C
// Default values:           0xD3, 
...
*/
#define RF_M300k1_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x79

/*
// Set properties:           RF_M300k1_MODEM_TX_RAMP_DELAY_8
...
*/
#define RF_M300k1_MODEM_TX_RAMP_DELAY_8 0x11, 0x20, 0x08, 0x18, 0x01, 0x80, 0x08, 0x03, 0x40, 0x00, 0x30, 0x10

/*
// Set properties:           RF_M300k1_MODEM_BCR_OSR_1_9
...
*/
#define RF_M300k1_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x04, 0x3B, 0x00, 0x78, 0xFD, 0x00, 0x3D, 0x02, 0xC2

/*
// Set properties:           RF_M300k1_MODEM_AFC_GEAR_7
...
*/
#define RF_M300k1_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x05, 0x34, 0x7D, 0x80

/*
// Set properties:           RF_M300k1_MODEM_AGC_CONTROL_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x35
// Default values:           0xE0, 
...
*/
#define RF_M300k1_MODEM_AGC_CONTROL_1 0x11, 0x20, 0x01, 0x35, 0xE2

/*
// Set properties:           RF_M300k1_MODEM_AGC_WINDOW_SIZE_9
// Number of properties:     9
// Group ID:                 0x20
// Start ID:                 0x38
...
*/
#define RF_M300k1_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0xED, 0xED, 0x00, 0x02, 0x80, 0x00, 0x00, 0x2B

/*
// Set properties:           RF_M300k1_MODEM_OOK_CNT1_9
// Number of properties:     9
// Group ID:                 0x20
// Start ID:                 0x42
...
*/
#define RF_M300k1_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0x32, 0x01, 0x80, 0xFF

/*
// Set properties:           RF_M300k1_MODEM_RSSI_CONTROL_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x4C
// Default values:           0x01, 
...
*/
#define RF_M300k1_MODEM_RSSI_CONTROL_1 0x11, 0x20, 0x01, 0x4C, 0x10

/*
// Set properties:           RF_M300k1_MODEM_RSSI_COMP_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x4E
// Default values:           0x32, 
...
*/
#define RF_M300k1_MODEM_RSSI_COMP_1 0x11, 0x20, 0x01, 0x4E, 0x40

/*
// Set properties:           RF_M300k1_MODEM_CLKGEN_BAND_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x51
// Default values:           0x08, 
...
*/
#define RF_M300k1_MODEM_CLKGEN_BAND_1 0x11, 0x20, 0x01, 0x51, 0x0B

/*
// Set properties:           RF_M300k1_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x00
...
*/
#define RF_M300k1_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12 0x11, 0x21, 0x0C, 0x00, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1, 0xB9, 0xC9, 0xEA, 0x05, 0x12, 0x11

/*
// Set properties:           RF_M300k1_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x0C
...
*/
#define RF_M300k1_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0x0A, 0x04, 0x15, 0xFC, 0x03, 0x00, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1

/*
// Set properties:           RF_M300k1_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x18
...
*/
#define RF_M300k1_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12 0x11, 0x21, 0x0C, 0x18, 0xB9, 0xC9, 0xEA, 0x05, 0x12, 0x11, 0x0A, 0x04, 0x15, 0xFC, 0x03, 0x00

/*
// Set properties:           RF_M300k1_PA_TC_1
// Number of properties:     1
// Group ID:                 0x22
// Start ID:                 0x03
// Default values:           0x5D, 
...
*/
#define RF_M300k1_PA_TC_1 0x11, 0x22, 0x01, 0x03, 0x3D

/*
// Set properties:           RF_M300k1_SYNTH_PFDCP_CPFF_7
// Number of properties:     7
// Group ID:                 0x23
// Start ID:                 0x00
...
*/
#define RF_M300k1_SYNTH_PFDCP_CPFF_7 0x11, 0x23, 0x07, 0x00, 0x2C, 0x0E, 0x0B, 0x04, 0x0C, 0x73, 0x03

/*
// Set properties:           RF_M300k1_FREQ_CONTROL_INTE_8
// Number of properties:     8
// Group ID:                 0x40
// Start ID:                 0x00
...
*/
#define RF_M300k1_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x44, 0x09, 0xD8, 0x9D, 0x76, 0x27, 0x20, 0xFD
...
#define RADIO_M300k1_CONFIGURATION_DATA_ARRAY { \
        0x07, RF_M300k1_POWER_UP, \
        0x08, RF_M300k1_GPIO_PIN_CFG, \
        0x06, RF_M300k1_GLOBAL_XO_TUNE_2, \
        0x05, RF_M300k1_GLOBAL_CONFIG_1, \
        0x06, RF_M300k1_INT_CTL_ENABLE_2, \
        0x08, RF_M300k1_FRR_CTL_A_MODE_4, \
        0x05, RF_M300k1_PREAMBLE_CONFIG_1, \
        0x07, RF_M300k1_SYNC_CONFIG_3, \
        0x05, RF_M300k1_PKT_CONFIG1_1, \
        0x05, RF_M300k1_PKT_FIELD_1_CONFIG_1, \
        0x10, RF_M300k1_MODEM_MOD_TYPE_12, \
        0x05, RF_M300k1_MODEM_FREQ_DEV_0_1, \
        0x0C, RF_M300k1_MODEM_TX_RAMP_DELAY_8, \
        0x0D, RF_M300k1_MODEM_BCR_OSR_1_9, \
        0x0B, RF_M300k1_MODEM_AFC_GEAR_7, \
        0x05, RF_M300k1_MODEM_AGC_CONTROL_1, \
        0x0D, RF_M300k1_MODEM_AGC_WINDOW_SIZE_9, \
        0x0D, RF_M300k1_MODEM_OOK_CNT1_9, \
        0x05, RF_M300k1_MODEM_RSSI_CONTROL_1, \
        0x05, RF_M300k1_MODEM_RSSI_COMP_1, \
        0x05, RF_M300k1_MODEM_CLKGEN_BAND_1, \
        0x10, RF_M300k1_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, \
        0x10, RF_M300k1_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, \
        0x10, RF_M300k1_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, \
        0x05, RF_M300k1_PA_TC_1, \
        0x0B, RF_M300k1_SYNTH_PFDCP_CPFF_7, \
        0x0C, RF_M300k1_FREQ_CONTROL_INTE_8, \
        0x00 \
 }
